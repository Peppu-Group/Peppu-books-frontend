...
const Invoice = ({ data, pdfMode, onChange }) => {
    ...
    return (<Document pdfMode={pdfMode}>
        <Page className="invoice-wrapper" pdfMode={pdfMode}>
            ...
            <View className="flex" pdfMode={pdfMode}>
                ...
                <View className="w-50" pdfMode={pdfMode}>
                    <EditableInput className="fs-45 right bold dark" placeholder="Invoice" value={invoice.title} onChange={(value) => handleChange('title', value)} pdfMode={pdfMode} />
                </View>
            </View>
            ...
            {invoice.productLines.map((productLine, i) => {
                return pdfMode && productLine.description === '' ? (<Text key={i}></Text>) : (<View key={i} className="flex box" pdfMode={pdfMode}>
                    ...
                    {!pdfMode && (<button className="link row__remove" aria-label="Remove Row" title="Remove Row" onClick={() => handleRemove(i)}>
            ...
            <View className="flex" pdfMode={pdfMode}>
                ...
                <View className="p-1" pdfMode={pdfMode}>
                    <View className="flex" pdfMode={pdfMode}>
                    ...
                    <View className="flex bg-gray " pdfMode={pdfMode}>
                        <View className="w-50 p-1" pdfMode={pdfMode}>
                            <EditableInput className="txt-gray bold" value={invoice.totalLabel} onChange={(value) => handleChange('totalLabel', value)} pdfMode={pdfMode} />
                        </View>
                        <View className="w-50 p-1 flex" pdfMode={pdfMode}>
                            <EditableInput className="txt-gray dark bold right ml-30" value={invoice.currency} onChange={(value) => handleChange('currency', value)} pdfMode={pdfMode} />
