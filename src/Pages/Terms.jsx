        ...
        <main class="root">
            ...
            <div className='privacy-section'>
                <div className='body-header'>
                    <p className='header'>Terms of</p>
                    <p>Service</p>
                </div>
            </div>
            <div className='consent-window'>
                <p>
                    These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and Peppubooks company ("Company", “we”, “us”, or “our”), concerning your access to and use of the peppubooks.com website
